...
## Troubleshooting de publicação (GitHub Pages)
Se a página aparecer com texto começando em `diff --git ...` e vários `+`/`-`, isso normalmente indica que um **patch/diff foi publicado como HTML** por engano, em vez do arquivo final renderizável.
...
Se falhar, restaure os arquivos da versão correta e publique novamente.
